 ...
 *
 * @namespace Fl32_Dup_Front_Widget_Cfg_Info
 */
// MODULE'S VARS
const NS = 'Fl32_Dup_Front_Widget_Cfg_Info';

// MODULE'S FUNCTIONS
/**
 * TeqFW DI factory function to get dependencies for the object.
 *
 * @returns {Fl32_Dup_Front_Widget_Cfg_Info.vueCompTmpl}
 */
...
`;
     ...
     * @memberOf Fl32_Dup_Front_Widget_Cfg_Info
     */
    return {
