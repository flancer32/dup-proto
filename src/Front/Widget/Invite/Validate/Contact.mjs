 ...
 *
 * @namespace Fl32_Dup_Front_Widget_Invite_Validate_Contact
 */
// MODULE'S VARS
const NS = 'Fl32_Dup_Front_Widget_Invite_Validate_Contact';
 ...
 *
 * @returns {Fl32_Dup_Front_Widget_Invite_Validate_Contact.vueCompTmpl}
 */
...
`;
     ...
     * @memberOf Fl32_Dup_Front_Widget_Invite_Validate_Contact
     */
    return {
