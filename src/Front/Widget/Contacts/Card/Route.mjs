 ...
 *
 * @namespace Fl32_Dup_Front_Widget_Contacts_Card_Route
 */
// MODULE'S VARS
const NS = 'Fl32_Dup_Front_Widget_Contacts_Card_Route';

// MODULE'S FUNCTIONS
/**
 * Factory to create template for new Vue component instances.
 *
 * @returns {Fl32_Dup_Front_Widget_Contacts_Card_Route.vueCompTmpl}
 */
...
`;
     ...
     * @memberOf Fl32_Dup_Front_Widget_Contacts_Card_Route
     */
    return {
