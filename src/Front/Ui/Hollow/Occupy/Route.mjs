 ...
 *
 * @namespace Fl32_Dup_Front_Ui_Hollow_Occupy_Route
 */
// MODULE'S VARS
const NS = 'Fl32_Dup_Front_Ui_Hollow_Occupy_Route';

// MODULE'S FUNCTIONS
/**
 * Factory to create template for new Vue component instances.
 *
 * @returns {Fl32_Dup_Front_Ui_Hollow_Occupy_Route.vueCompTmpl}
 */
...
`;
     ...
     * @memberOf Fl32_Dup_Front_Ui_Hollow_Occupy_Route
     */
    return {
