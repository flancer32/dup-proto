 ...
 *
 * @namespace Fl32_Dup_Front_Ui_Chat_Msg_Band_Item
 */
// MODULE'S VARS
const NS = 'Fl32_Dup_Front_Ui_Chat_Msg_Band_Item';
...
/**
 * @interface
 * @memberOf Fl32_Dup_Front_Ui_Chat_Msg_Band_Item
 */
class IUiComp {
    setDelivered() {}
 ...
 *
 * @returns {Fl32_Dup_Front_Ui_Chat_Msg_Band_Item.vueCompTmpl}
 */
export default function (spec) {
    ...
    const uiChatBand = spec['Fl32_Dup_Front_Widget_Chat_Band$'];
