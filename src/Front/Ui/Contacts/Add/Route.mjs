 ...
 *
 * @namespace Fl32_Dup_Front_Ui_Contacts_Add_Route
 */
// MODULE'S VARS
const NS = 'Fl32_Dup_Front_Ui_Contacts_Add_Route';
 ...
 *
 * @returns {Fl32_Dup_Front_Ui_Contacts_Add_Route.vueCompTmpl}
 */
export default function (spec) {
    ...
    /** @type {Fl32_Dup_Front_Ui_Contacts_Add_DialogLink.vueCompTmpl} */
    const dialogLink = spec['Fl32_Dup_Front_Ui_Contacts_Add_DialogLink$'];
    /** @type {Fl32_Dup_Front_Widget_Contacts_Add_DialogLink} */
    const uiDialogLink = spec['Fl32_Dup_Front_Widget_Contacts_Add_DialogLink$'];
...
`;
     ...
     * @memberOf Fl32_Dup_Front_Ui_Contacts_Add_Route
     */
    return {
