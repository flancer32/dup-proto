 ...
 *
 * @namespace Fl32_Dup_Front_Ui_Contacts_Add_DialogLink
 */
// MODULE'S VARS
const NS = 'Fl32_Dup_Front_Ui_Contacts_Add_DialogLink';

// MODULE'S FUNCTIONS
/**
 * TeqFW DI factory function to get dependencies for the object.
 *
 * @returns {Fl32_Dup_Front_Ui_Contacts_Add_DialogLink.vueCompTmpl}
 */
export default function (spec) {
    /** @type {Fl32_Dup_Front_Defaults} */
    const DEF = spec['Fl32_Dup_Front_Defaults$'];
    /** @type {Fl32_Dup_Front_Widget_Contacts_Add_DialogLink} */
    const uiLink = spec['Fl32_Dup_Front_Widget_Contacts_Add_DialogLink$'];
...
`;
     ...
     * @memberOf Fl32_Dup_Front_Ui_Contacts_Add_DialogLink
     */
    return {
