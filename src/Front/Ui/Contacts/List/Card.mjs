 ...
 * Contacts card.
 *
 * @namespace Fl32_Dup_Front_Ui_Contacts_List_Card
 */
// MODULE'S VARS
const NS = 'Fl32_Dup_Front_Ui_Contacts_List_Card';

// MODULE'S FUNCTIONS
/**
 * Factory to create template for new Vue component instances.
 *
 * @returns {Fl32_Dup_Front_Ui_Contacts_List_Card.vueCompTmpl}
 */
...
`;
     ...
     * @memberOf Fl32_Dup_Front_Ui_Contacts_List_Card
     */
    return {
