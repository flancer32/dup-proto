 ...
 *
 * @namespace Fl32_Dup_Front_Ui_Cfg_Profile
 */
// MODULE'S VARS
const NS = 'Fl32_Dup_Front_Ui_Cfg_Profile';

// MODULE'S FUNCTIONS
/**
 * TeqFW DI factory function to get dependencies for the object.
 *
 * @returns {Fl32_Dup_Front_Ui_Cfg_Profile.vueCompTmpl}
 */
...
`;
     ...
     * @memberOf Fl32_Dup_Front_Ui_Cfg_Profile
     */
    return {
