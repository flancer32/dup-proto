 ...
 *
 * @namespace Fl32_Dup_Front_Ui_Cfg_WebPush
 */
// MODULE'S VARS
const NS = 'Fl32_Dup_Front_Ui_Cfg_WebPush';

// MODULE'S FUNCTIONS
/**
 * TeqFW DI factory function to get dependencies for the object.
 *
 * @returns {Fl32_Dup_Front_Ui_Cfg_WebPush.vueCompTmpl}
 */
...
`;
     ...
     * @memberOf Fl32_Dup_Front_Ui_Cfg_WebPush
     */
    return {
