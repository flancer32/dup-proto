 ...
 * 'Home' route.
 *
 * @namespace Fl32_Dup_Front_Ui_Home_Conversation
 */
// MODULE'S VARS
const NS = 'Fl32_Dup_Front_Ui_Home_Conversation';

// MODULE'S FUNCTIONS
/**
 * Factory to create template for new Vue component instances.
 *
 * @returns {Fl32_Dup_Front_Ui_Home_Conversation.vueCompTmpl}
 */
...
`;
     ...
     * @memberOf Fl32_Dup_Front_Ui_Home_Conversation
     */
    return {
