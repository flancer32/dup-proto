 ...
 * 'Home' route.
 *
 * @namespace Fl32_Dup_Front_Ui_Home_Route
 */
// MODULE'S VARS
const NS = 'Fl32_Dup_Front_Ui_Home_Route';

// MODULE'S FUNCTIONS
/**
 * Factory to create template for new Vue component instances.
 *
 * @returns {Fl32_Dup_Front_Ui_Home_Route.vueCompTmpl}
 */
export default function (spec) {
    ...
    /** @type {Fl32_Dup_Front_Ui_Home_Conversation.vueCompTmpl} */
    const conversation = spec['Fl32_Dup_Front_Ui_Home_Conversation$'];
    ...
    const uiConv = spec['Fl32_Dup_Front_Widget_Home_Conversation$'];
...
`;
     ...
     * @memberOf Fl32_Dup_Front_Ui_Home_Route
     */
    return {
