 ...
 *
 * @namespace Fl32_Dup_Front_Proc_User_RegNew
 */
// MODULE'S VARS
const NS = 'Fl32_Dup_Front_Proc_User_RegNew';
...
export default function (spec) {
     ...
     * @memberOf Fl32_Dup_Front_Proc_User_RegNew
     */
    async function process({invite} = {}) {
