...
export default class Fl32_Dup_Shared_Event_Back_Msg_Confirm_Post {
    constructor(spec) {
        ...
        // INSTANCE METHODS
        /**
         * @param {{data: Fl32_Dup_Shared_Event_Back_Msg_Confirm_Post.Dto, meta: TeqFw_Web_Event_Shared_Dto_Event_Meta.Dto}} [data]
         * @return {{data: Fl32_Dup_Shared_Event_Back_Msg_Confirm_Post.Dto, meta: TeqFw_Web_Event_Shared_Dto_Event_Meta.Dto}}
         */
