...
export default class Fl32_Dup_Shared_Event_Back_User_Invite_Validate_Response {
    constructor(spec) {
        ...
        // INSTANCE METHODS
        /**
         * @param {{data: Fl32_Dup_Shared_Event_Back_User_Invite_Validate_Response.Dto, meta: TeqFw_Web_Event_Shared_Dto_Event_Meta.Dto}} [data]
         * @return {{data: Fl32_Dup_Shared_Event_Back_User_Invite_Validate_Response.Dto, meta: TeqFw_Web_Event_Shared_Dto_Event_Meta.Dto}}
         */
