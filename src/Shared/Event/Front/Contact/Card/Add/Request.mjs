...
export default class Fl32_Dup_Shared_Event_Front_Contact_Card_Add_Request {
    constructor(spec) {
        ...
        // INSTANCE METHODS
        /**
         * @param {{data: Fl32_Dup_Shared_Event_Front_Contact_Card_Add_Request.Dto, meta: TeqFw_Web_Event_Shared_Dto_Event_Meta.Dto}} [data]
         * @return {{data: Fl32_Dup_Shared_Event_Front_Contact_Card_Add_Request.Dto, meta: TeqFw_Web_Event_Shared_Dto_Event_Meta.Dto}}
         */
